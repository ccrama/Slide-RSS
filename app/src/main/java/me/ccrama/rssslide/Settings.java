...
public class Settings extends BaseActivity {
    ...
    private void setSettingItems() {
        ...
        findViewById(R.id.about).setOnClickListener(new OnSingleClickListener() {
            @Override
            public void onSingleClick(View v) {
                //todo Intent i = new Intent(Settings.this, SettingsAbout.class);
                //startActivity(i);
            }
        });
        ...
        findViewById(R.id.offline).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Manage cache todo   Intent i = new Intent(Settings.this, ManageOfflineContent.class);
                //   startActivity(i);
            }
        });
        ...
        findViewById(R.id.tablet).setOnClickListener(new OnSingleClickListener() {
            ...
            public void onSingleClick(View view) {
                ...
                if (SettingValues.tabletUI) {
                    ...
                    landscape.setProgress(MainActivity.dpWidth - 1);
                    ...
                    dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        ...
                        public void onDismiss(DialogInterface dialog) {
                            MainActivity.dpWidth = landscape.getProgress() + 1;
                            MainActivity.colors.edit()
