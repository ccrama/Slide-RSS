package me.ccrama.rssslide.Util;
...
public class Constants {
     ...
     * "Tabs" view mode.
     */
    public static final int TAB_HEADER_VIEW_OFFSET = MainActivity.dpToPxVertical(108);
     ...
     * "Single" view mode.
     */
    public static final int SINGLE_HEADER_VIEW_OFFSET = MainActivity.dpToPxVertical(56);
     ...
     */
    public static final int PTR_OFFSET_TOP = MainActivity.dpToPxVertical(40);
    public static final int PTR_OFFSET_BOTTOM = MainActivity.dpToPxVertical(18);
