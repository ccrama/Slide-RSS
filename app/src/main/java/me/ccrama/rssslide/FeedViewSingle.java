...
public class FeedViewSingle extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        feed = getIntent().getExtras().getString(EXTRA_FEED, "");
        applyColorTheme(feed);
        setContentView(R.layout.activity_singlefeed);
        setupSubredditAppBar(R.id.toolbar, feed, true, feed);
